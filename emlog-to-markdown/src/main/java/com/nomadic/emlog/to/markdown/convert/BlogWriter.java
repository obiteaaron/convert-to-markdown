...
public class BlogWriter {
    private static final String GLOBAL_FILE_PATH = "D:/Workspaces/IntelliJIdea/emlog_blog";
    private static final String GLOBAL_ATTACHMENT_PATH = "D:/webroot/emlog";

    public static void mkdirs(String path) {
        File file = new File(BlogWriter.GLOBAL_FILE_PATH, path);
        if (!file.exists()) {
